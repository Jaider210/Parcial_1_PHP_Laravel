<template>
  <div class="max-w-lg mx-auto py-8">
    <h2 class="text-xl font-semibold mb-6">Crear nuevo Teléfono</h2>
...
function submit() {
  errors.value = {}
  router.post('/phones', form, {
    onError: (err) => errors.value = err,
    onSuccess: () => success.value = '¡Teléfono creado exitosamente!',
  })
}

// Botón para regresar al listado de teléfonos
function goBack() {
  router.visit('/phones')
}
</script>
